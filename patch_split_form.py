...
new = '''            st.caption(
    ...
    with st.form("metabolic_assessment_form_part2"):
        st.subheader("5. Diet and lifestyle")'''

if old not in content:
    print("ERROR: pattern A not found")
else:
    content = content.replace(old, new, 1)

old2 = '''    with st.form("metabolic_assessment_form"):'''
new2 = '''    with st.form("metabolic_assessment_form_part1"):'''
if old2 not in content:
    print("ERROR: pattern B not found")
else:
...
print("DONE - check for ERROR lines above")
