...
def render_metabolic_assessment():
    ...
    with st.form("metabolic_assessment_form"):
        ...
        want_egdr = st.checkbox("I'd like to check my eGDR (needs HbA1c)")
        hba1c = None
        if want_egdr:
        ...
        # --- Q6: Liver health (optional) ---
        st.subheader("6. Liver health (optional)")
        ...
        if want_liver:
            st.caption(
                ...
                "usually reported in U/L. Platelet count is from a CBC report "
            ...
            if have_platelets:
                platelets = st.number_input(
                    "Platelet count (x10\u2079/L)", min_value=50.0, max_value=600.0, value=250.0
                )
